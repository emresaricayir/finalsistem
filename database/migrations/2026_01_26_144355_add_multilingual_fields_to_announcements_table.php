...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('UPDATE announcements SET title_tr = title WHERE title_tr IS NULL');
        DB::statement('UPDATE announcements SET content_tr = content WHERE content_tr IS NULL');
    ...
    public function down(): void
    {
        ...
        DB::statement('UPDATE announcements SET title = title_tr WHERE title IS NULL');
        DB::statement('UPDATE announcements SET content = content_tr WHERE content IS NULL');
