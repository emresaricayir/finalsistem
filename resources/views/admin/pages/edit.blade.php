    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">
                ...
                Sayfa Düzenle: {{ $page->getRawOriginal('title_tr') }}
            </h1>
            <p class="mt-2 text-gray-600">Sayfa içeriğini düzenleyin ve güncelleyin.</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   id="title_tr"
                                   required
                                   value="{{ old('title_tr', $page->getRawOriginal('title_tr')) }}"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="title_de"
                                   id="title_de"
                                   value="{{ old('title_de', $page->getRawOriginal('title_de')) }}"
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="border border-gray-300 rounded-xl overflow-hidden">
                        <textarea name="content_tr" id="content_tr">{{ old('content_tr', $page->getRawOriginal('content_tr')) }}</textarea>
                    </div>
                    @error('content_tr')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="border border-gray-300 rounded-xl overflow-hidden">
                        <textarea name="content_de" id="content_de">{{ old('content_de', $page->getRawOriginal('content_de')) }}</textarea>
                    </div>
                    @error('content_de')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description_tr"
                                      ...
                                      placeholder="Arama motorları için sayfa açıklaması">{{ old('meta_description_tr', $page->getRawOriginal('meta_description_tr')) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   id="meta_keywords_tr"
                                   value="{{ old('meta_keywords_tr', $page->getRawOriginal('meta_keywords_tr')) }}"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description_de"
                                      ...
                                      placeholder="Seitenbeschreibung für Suchmaschinen">{{ old('meta_description_de', $page->getRawOriginal('meta_description_de')) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   id="meta_keywords_de"
                                   value="{{ old('meta_keywords_de', $page->getRawOriginal('meta_keywords_de')) }}"
