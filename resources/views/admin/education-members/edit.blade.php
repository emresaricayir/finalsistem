...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Veli Düzenle</h1>
                <p class="text-slate-600 mt-1">Veli bilgilerini güncelleyin</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200">
        <form action="{{ route('admin.education-members.update', $educationMember) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="name"
                               id="name"
                               value="{{ old('name', $educationMember->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="surname"
                               id="surname"
                               value="{{ old('surname', $educationMember->surname) }}"
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="student_name"
                               id="student_name"
                               value="{{ old('student_name', $educationMember->student_name) }}"
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               id="student_surname"
                               value="{{ old('student_surname', $educationMember->student_surname) }}"
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="active" {{ old('status', $educationMember->status) == 'active' ? 'selected' : '' }}>Aktif</option>
                            <option value="inactive" {{ old('status', $educationMember->status) == 'inactive' ? 'selected' : '' }}>Pasif</option>
                            @if($educationMember->status === 'suspended')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="email"
                               name="email"
                               id="email"
                               value="{{ old('email', $educationMember->email) }}"
                    ...
                    <div>
                        ...
                        <input type="tel"
                               name="phone"
                               id="phone"
                               value="{{ old('phone', $educationMember->phone) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date"
                               ...
                               id="membership_date"
                               value="{{ old('membership_date', $educationMember->membership_date?->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="monthly_dues"
                               id="monthly_dues"
                               value="{{ old('monthly_dues', $educationMember->monthly_dues) }}"
                               min="0"
                               step="0.01"
            ...
            <div class="px-6 py-4">
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" rows="4"
                              ...
                              placeholder="Ek notlar...">{{ old('notes', $educationMember->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
