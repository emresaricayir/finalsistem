...
@section('title', 'Yeni Hızlı Erişim Ekle')

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="max-w-6xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-teal-800">Yeni Hızlı Erişim Ekle</h1>
                ...
                <form action="{{ route('admin.quick-access.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div id="description-tab-content-tr" class="tab-content">
                            <textarea name="description_tr" id="description_tr" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                      oninput="updatePreview()" placeholder="Türkçe açıklama giriniz">{{ old('description_tr') }}</textarea>
                        ...
                        <div id="description-tab-content-de" class="tab-content hidden">
                            <textarea name="description_de" id="description_de" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                      oninput="updatePreview()" placeholder="Almanca açıklama giriniz">{{ old('description_de') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <input type="text" name="icon" id="icon" value="{{ old('icon', 'fa-cog') }}" required
                            ...
                            <div class="w-10 h-10 rounded-full flex items-center justify-center text-white" id="simple-icon-preview" style="background-color: #14b8a6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <input type="color" name="icon_color" id="icon_color" value="{{ old('icon_color', '#14b8a6') }}" required
                            ...
                            <input type="text" value="{{ old('icon_color', '#14b8a6') }}" readonly
                        ...
                        <div class="group relative transform transition-all duration-500">
                            ...
                            <div class="relative overflow-hidden rounded-2xl bg-white/70 backdrop-blur-md border border-white/20 shadow-xl transition-all duration-500 p-6 text-center h-[200px] flex flex-col justify-between" id="preview-card">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <!-- Title -->
                                    <h4 class="text-lg font-bold text-gray-800 mb-2 leading-tight transition-colors duration-300" id="preview-title">Örnek Başlık</h4>
...
function updatePreview() {
    try {
        ...
        const title = titleTr || titleDe || 'Örnek Başlık';
        
        const icon = iconEl.value || 'fa-cog';
        const color = colorEl.value || '#14b8a6';
