...
<div class="p-6">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="p-6">
                <form action="{{ route('admin.settings.tv-display-messages.update', $tvDisplayMessage) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 @error('title') border-red-500 @enderror"
                               id="title" name="title" value="{{ old('title', $tvDisplayMessage->title) }}" maxlength="80" required>
                        @error('title')
                    ...
                    <div class="mt-6">
                        ...
                        <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 @error('content') border-red-500 @enderror"
                                  id="content" name="content" rows="6" maxlength="300" placeholder="Mesaj içeriğini buraya yazın... (Maksimum 300 karakter)">{{ old('content', $tvDisplayMessage->content) }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">
                    ...
                    <div class="mt-6">
                        ...
                        @if($tvDisplayMessage->image)
                            <div class="mb-3">
                                <img src="{{ asset($tvDisplayMessage->image) }}" alt="Mevcut resim" class="w-32 h-32 object-cover rounded-lg border">
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 @error('footer_text') border-red-500 @enderror"
                               id="footer_text" name="footer_text" value="{{ old('footer_text', $tvDisplayMessage->footer_text) }}">
                        @error('footer_text')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    @else
                                        ...
                                        <input type="checkbox"
                                               ...
                                               name="display_pages[]"
                                               value="{{ $page }}"
                                               {{ in_array($page, old('display_pages', $tvDisplayMessage->display_pages ?? [])) ? 'checked' : '' }}>
                    ...
                    <div class="mt-6">
                        <div class="flex items-center">
                            <input type="checkbox" class="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                                   id="is_active" name="is_active" value="1" {{ old('is_active', $tvDisplayMessage->is_active) ? 'checked' : '' }}>
