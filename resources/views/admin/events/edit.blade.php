...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">{{ $event->title_tr ?? $event->title_de }}</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="title_tr"
                               id="title_tr"
                               value="{{ old('title_tr', $event->title_tr) }}"
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="title_de"
                               id="title_de"
                               value="{{ old('title_de', $event->title_de) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <textarea name="description_tr"
                                  ...
                                  placeholder="Etkinlik hakkında detaylı bilgi...">{{ old('description_tr', $event->description_tr) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="description_de"
                                  ...
                                  placeholder="Detaillierte Informationen zur Veranstaltung...">{{ old('description_de', $event->description_de) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   id="display_duration"
                                   value="{{ old('display_duration', $event->display_duration) }}"
                                   min="1"
                                   max="60"
