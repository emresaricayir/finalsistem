...
@section('title', 'Yeni Vefa Fotoğrafı Oluştur')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Yeni Vefa Fotoğrafı Oluştur</h1>
            <p class="mt-1 text-sm text-gray-600">Vefa fotoğrafı için yeni bir kayıt oluşturun</p>
        </div>
    ...
    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('admin.vefas.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                            Vesikalık Fotoğraf <span class="text-red-500">*</span>
                        </label>
                        <input type="file"
                               name="image"
                               id="image"
                               ...
                               required>
                        <p class="mt-1 text-sm text-gray-500">JPEG, PNG, JPG, GIF formatları desteklenir. Maksimum 2MB.</p>
                        @error('image')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
