...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 text-sm mt-1">{{ $personnelCategory->getRawNameAttribute() }} kategorisini düzenleyin</p>
        </div>
    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.personnel-categories.update', $personnelCategory) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div id="content-tr" class="tab-content">
                ...
                <div>
                    ...
                    <input type="text"
                           id="name_tr"
                           name="name_tr"
                           value="{{ old('name_tr', $personnelCategory->getRawOriginal('name_tr')) }}"
                ...
                <div>
                    ...
                    <textarea id="description_tr"
                              ...
                              placeholder="Kategori hakkında kısa açıklama...">{{ old('description_tr', $personnelCategory->getRawOriginal('description_tr')) }}</textarea>
            ...
            <div id="content-de" class="tab-content hidden">
                ...
                <div>
                    ...
                    <input type="text"
                           id="name_de"
                           name="name_de"
                           value="{{ old('name_de', $personnelCategory->getRawOriginal('name_de')) }}"
                ...
                <div>
                    ...
                    <textarea id="description_de"
                              ...
                              placeholder="Kurze Beschreibung der Kategorie...">{{ old('description_de', $personnelCategory->getRawOriginal('description_de')) }}</textarea>
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <input type="color"
                           id="color"
                           name="color"
                           value="{{ old('color', $personnelCategory->color) }}"
            ...
            <div>
                ...
                <input type="number"
                       id="sort_order"
                       name="sort_order"
                       value="{{ old('sort_order', $personnelCategory->sort_order) }}"
                       min="0"
            ...
            <div class="flex items-center">
                <input type="checkbox"
                       ...
                       name="is_active"
                       value="1"
                       {{ old('is_active', $personnelCategory->is_active) ? 'checked' : '' }}
