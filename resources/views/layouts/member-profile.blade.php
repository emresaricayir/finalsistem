        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="hidden lg:flex flex-row gap-3 md:gap-8 py-6">
                ...
                <a href="{{ route('member.dsgvo') }}"
                   class="{{ request()->routeIs('member.dsgvo') ? 'bg-teal-500/30 text-white border-b-2 border-teal-400 shadow-lg' : 'text-teal-100 hover:text-white hover:bg-white/10' }} pb-3 px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 hover:shadow-lg flex items-center">
            ...
            <div id="mobile-menu" class="hidden lg:hidden pb-4">
                <nav class="flex flex-col space-y-2">
                    ...
                    <a href="{{ route('member.dsgvo') }}"
                       class="{{ request()->routeIs('member.dsgvo') ? 'bg-teal-500/30 text-white border-l-4 border-teal-400' : 'text-teal-100 hover:text-white hover:bg-white/10' }} px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 flex items-center">
